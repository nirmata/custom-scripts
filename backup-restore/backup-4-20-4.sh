...
NIRMATA_SERVICES="Activity-nirmata Availability-cluster-hc-nirmata Availability-config-env-nirmata Availability-env-app-nirmata Catalog-nirmata Cluster-nirmata Config-nirmata Environments-nirmata Policies-nirmata TimeSeries-Metrics-nirmata TimeSeries-nirmata Users-nirmata"
