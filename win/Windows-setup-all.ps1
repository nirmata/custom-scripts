...
function InstallKubelet()
{
    ...
    Write-Host "Open firewall for 10250. Required for kubectl exec pod"
...
function CreateExternalNetwork
{
    ...
    Write-Host "Open firewall for Overlay traffic"
    ...
    {
        Write-Host "Create a Overlay network to trigger a vSwitch creation"
...
Write-Host "Update Network Config"
...
# Install CNI & Flannel
Write-Host "Create External Network "
